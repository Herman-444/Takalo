    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-about">
                ...
                <p>Takalo est une plateforme d'échange d'objets entre particuliers. Échangez vos objets facilement et en toute sécurité.</p>
            ...
            <div>
                ...
                <ul class="footer-links">
                    <li><a href="/accueil/accueil">Accueil</a></li>
                    <li><a href="/user/objets">Mes Objets</a></li>
                    <li><a href="/user/echanges">Mes Échanges</a></li>
                    <li><a href="/user/objets/create">Publier un objet</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="/user/inscription">Inscription</a></li>
                    <li><a href="/user/objets">Gérer mes objets</a></li>
